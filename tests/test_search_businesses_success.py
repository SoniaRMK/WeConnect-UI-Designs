...
class TestBusiness(unittest.TestCase):
    ...
    def setUp(self):
        ...
        db.drop_all()
        db.create_all()
        self.user = {'user_email' : 'soniak@gmail.com', 'user_name': 'Kaynyks000', 
    ...
    def test_get_all_businesses_with_search_term(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=mtn', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_and_limit(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&limit=2', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_and_location(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&location=Kampala', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_and_category(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&category=Telecomm', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_category_and_location(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&category=Telecomm&location=Kampala', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_location_and_limit(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&limit=2&location=Kampala', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_category_and_limit(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&limit=2&category=Telecomm', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_all_businesses_with_search_term_location_category_and_limit(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=MTN&limit=2&location=Kampala&category=Telecomm', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_limit_less_than_zero(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?limit=0', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
    ...
    def test_get_all_businesses_with_search_term_location_category_and_limit_not_found(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses?q=airtel&limit=2&location=Kampala&category=Telecomm', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
