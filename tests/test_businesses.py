...
class TestBusiness(unittest.TestCase):
    ...
    def test_create_business_without_authentication(self):
        ...
        response = self.app.post('/api/v2/businesses',
                                content_type = 'application/json', data = json.dumps(self.business))
    ...
    def test_create_business_with_many_spaces_in_business_name(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel    Uganda',
                                            'location' : 'Kampala', 'category' : 'Telecomm', 
                                            'business_profile': 'Best Telecomm Company'}))
    ...
    def test_create_business_with_many_spaces_in_business_location(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel Uganda',
                                            'location' : 'Kampala   Road', 'category' : 'Telecomm', 
                                            'business_profile': 'Best Telecomm Company'}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_create_business_with_many_spaces_in_business_category(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel Uganda','location' : 'Kampala Road', 
                            'category' : 'Telecomm  and   Electronics', 
                            'business_profile': 'Best Telecomm Company'}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_create_business_with_long_name(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel UgandaAirtel UgandaAirtel UgandaAirtel\
                                             UgandaAirtel UgandaAirtel UgandaAirtel UgandaAirtel Uganda',
                                            'location' : 'Kampala', 'category' : 'Telecomm', 
                                            'business_profile': 'Best Telecomm Company'}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_create_business_with_long_category_name(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel Uganda','location' : 'Kampala', 
                                            'category' : 'TelecommunicationsTelecommunicationsTelecommunications\
    ...
    def test_create_business_with_long_location_name(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel Uganda','location' : 'KampalaKampa\
                                                laKampalaKampalaKampalaKampalaKampalaKampalaKampalaKampalaKampala', 
    ...
    def test_editing_business_success(self):
        ...
        response = self.app.put('/api/v2/businesses/1', content_type = 'application/json',
                                headers={'Authorization': 'Bearer ' + self.get_token()}, 
                                data = json.dumps(self.business_edit)) 
    ...
    def test_edit_business_with_many_spaces_in_business_category(self):
        ...
        response = self.app.put('/api/v2/businesses/1', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel Uganda',
                            'location' : 'Kampala Road', 'category' : 'Telecomm  and   Electronics', 
                            'business_profile': 'Best Telecomm Company'}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_edit_business_with_long_name(self):
        ...
        response = self.app.put('/api/v2/businesses/1', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel UgandaAirtel UgandaAirtel\
                             UgandaAirtel UgandaAirtel UgandaAirtel UgandaAirtel UgandaAirtel Uganda',
                             'location' : 'Kampala', 'category' : 'Telecomm', 
                            'business_profile': 'Best Telecomm Company'}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_edit_business_with_long_category_name(self):
        ...
        response = self.app.put('/api/v2/businesses/1', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer '  + self.get_token()}, 
                            data = json.dumps({'business_name': 'Airtel Uganda',
                            'location' : 'Kampala', 'category' : 'TelecommunicationsTelecommunications\
    ...
    def test_deleting_business_not_exist(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        del_result = self.app.delete('/api/v2/businesses/2', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
    ...
    def test_business_owner_only_can_delete_business(self):
        ...
        register = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        del_response = self.app.delete('/api/v2/businesses/1', 
                            headers={'Authorization': 'Bearer ' + self.get_token_two()}, 
                            data = json.dumps(self.business_edit), content_type = 'application/json')
    ...
    def test_get_one_business_not_exist(self):
        ...
        response = self.app.post('/api/v2/businesses', content_type = 'application/json', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            data = json.dumps(self.business))
        response = self.app.get('/api/v2/businesses/2', 
                            headers={'Authorization': 'Bearer ' + self.get_token()}, 
                            content_type = 'application/json')
        self.assertEqual(response.status_code, 404)
